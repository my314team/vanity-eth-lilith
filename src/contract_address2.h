...
__global__ void __launch_bounds__(BLOCK_SIZE, 2) gpu_contract2_address_work(int score_method, Address a, _uint256 base_key, _uint256 bytecode, uint32_t prefix[MAX_PREFIX_BYTES / 4], int prefix_bytes) {
